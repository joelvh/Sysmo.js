...
(function(undefined) {
  ...
  var Sysmo = {
    ...
    isPlainObject: function(value) {
      return this.isType(value, "Object") && value.constructor === Object;
    },
    isObject: function(value) {
      return value && !this.isArray(value) && typeof value == "object";
    },
    ...
    getDeepValue: function (target, path, traverseArrays) {
      ...
      var deeper = arguments.callee;
      
      // if traversing arrays is enabled and this is an array, loop
      if (traverseArrays && this.isArray(target)) {
        
        var children = [];
        
        for (var i = 0; i < target.length; i++) {
          // recursively loop through children
          var child = deeper.call(this, target[i], path, traverseArrays);
      ...
      if (target != null && properties.length) {
        ...
        return deeper(target, properties.join('.'), traverseArrays);
      }
    },
